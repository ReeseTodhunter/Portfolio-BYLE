...
public class ShatterCannonWeapon : ProjectileWeapon
{
    ...
    protected override void OnShoot()
    {
        ...
        currentProjectile.GetComponent<ShatterProjectile>().InitShards(shardPrefab,shardSpeed * (1 + PlayerController.instance.GetModifier(ModifierType.ProjectileSpeed)), shardAcceleration,shardDamage * (1 + PlayerController.instance.GetModifier(ModifierType.Damage)), shardLifeTime,shardCount,360.0f);
    ...
    public override void OnFireTwoDown()
    {
        ...
        {
            currentProjectile.GetComponent<ShatterProjectile>().ForceDestroyObject();
        }
    }
}
