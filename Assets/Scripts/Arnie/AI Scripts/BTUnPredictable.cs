...
public class BTUnPredictable : BTNode
{
    /*
    ...
    */
    ...
    public BTUnPredictable(GameObject _projectilePrefab, float _projectileCount, float _shotInterval, float _damage, float _speed, float _nodeCooldown = 3, string _animName = "", float _spreadInDegrees = 15) //Constructor
    {
        //Set all variables
    ...
    private void FireProjectile() //Fire projectile method
    {
        ...
        newSpeed = Random.Range(0, 5) + speed;
        ...
        newProjectie.GetComponent<Projectile>().Init(newSpeed, 0, 10, damage, agent.gameObject); //init projectile script
