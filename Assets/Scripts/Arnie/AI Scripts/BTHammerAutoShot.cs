...
public class BTHammerAutoShot : BTNode
{
    /*
    ...
    */
    ...
    public BTHammerAutoShot(GameObject _projectilePrefab, float _projectileCount, float _shotInterval, float _damage, float _speed, float _nodeCooldown = 3, string _animName = "", float _spreadInDegrees = 15) //Constructor
    {
        //Set all variables
    ...
    private void FireProjectile() //Fire projectile method
    {
        ...
        newProjectie.GetComponent<BasicProjectile>().Init(speed, 0, 10, damage, "Enemy");//"agent.gameObject); //init projectile script
