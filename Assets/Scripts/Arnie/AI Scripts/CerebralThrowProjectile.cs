...
public class CerebralThrowProjectile : Projectile
{
    private BTCerebralThrow throwController;
    ...
    public void InitHat(BTCerebralThrow _throwController, float _returnDistance)
    {
    ...
    protected override void ProjectileUpdate()
    {
        ...
        if(activeTimer < 2.0f)
        {
            // Get position of player firer
            Vector3 targetPos = PlayerController.instance.gameObject.transform.position;
